...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container d-flex aligns-items-center justify-content-center mt-5">
            <p class="alert alert-danger h1">Page 1</p>
        </div>
        <div>
            <nav  class="d-flex aligns-items-center justify-content-center" style="height:200px">
                <ul class="d-flex list-unstyled ">
                    <li><a class="nav-link mt-5" href="{{url('/page3')}}">Page 3</a></li>
                    <li><a class="nav-link mt-5 h5 warning" href="{{url('/')}}">Page 1</a></li>
